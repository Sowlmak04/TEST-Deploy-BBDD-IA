// ---------- Modal detalle (pendientes + vistas) ----------
          ...
          rows.push(`
            <div class="seasonRatingsPanel" style="grid-column:1/-1;">
              ...
              >
                ...
                <span>
                  <strong>Valoración por temporadas</strong>
                  <small>Opcional · independiente de la valoración global de la serie.</small>
                </span>
              </button>
    ...
    detailBody.addEventListener("click", event => {
      ...
      if (toggle) {
        ...
        toggle.textContent = editor.hidden ? "Valorar temporadas" : "Ocultar valoraciones";
        return;
      }
