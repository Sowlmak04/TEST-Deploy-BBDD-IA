...
// Set estrellas usando el widget
    ...
    function renderDetailAsForm(item, { isSeries, isVistas }) {
      ...
      if (isVistas) {
        ...
        rows.push(field("Valoración Adri", detailRaterValue("adri", item.ratingAdri)));
        rows.push(field("Valoración Laura", detailRaterValue("laura", item.ratingLaura)));
                    ...
                    <div class="seasonRatingRow" data-season-number="${number}">
                      ...
                      <label>
                        ...
                        <input
                          ...
                          placeholder="—"
                          aria-label="Valoración Adri temporada ${number}"
                        >
                      </label>
                      <label>
                        <span>Laura</span>
                        <input
                          ...
                          placeholder="—"
                          aria-label="Valoración Laura temporada ${number}"
                        >
                      </label>
                    </div>
                  `;
              ...
              return `
                <div class="historyItem">
                  ...
                  <div class="historyMeta">
                    ...
                    <span>Adri: ${escapeHtml(historyRaterValue("adri", w.ratingAdri))}</span>
                    <span>Laura: ${escapeHtml(historyRaterValue("laura", w.ratingLaura))}</span>
                  </div>
    ...
    function saveSeenFromDetail() {
      ...
      if (!adriState.watched && !lauraState.watched) {
        setMsg(msgSeen, "Al menos Adri o Laura debe haber visto el título.", "error");
        return;
      }
