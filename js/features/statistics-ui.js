  ...
  return `
    <section class="statsSection" aria-labelledby="stats-ratings-title">
      ...
      <div class="statsActivityMetricGrid">
        ...
        ${statCard(formatRating(ratings.adriAverage), "Media Adri", "Solo valoraciones registradas")}
        ${statCard(formatRating(ratings.lauraAverage), "Media Laura", "Solo valoraciones registradas")}
      </div>
    </section>
  `;
}
  ...
  const rows = list => list.map(item => `
    <div class="statsAffinityRow">
      <div class="statsAffinityMain">
        ...
        <small>Adri ${escapeHtml(formatRating(item.adri))} · Laura ${escapeHtml(formatRating(item.laura))}</small>
      </div>
...
function renderRatingAffinity(ratings) {
  ...
  return `
    <section class="statsSection" aria-labelledby="stats-affinity-title">
      <div class="statsSectionHead">
        <div>
          <span class="statsEyebrow">Adri y Laura</span>
