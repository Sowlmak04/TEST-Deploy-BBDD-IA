...
function renderStatisticsTab(tab, dashboard) {
  ...
  return `
    ...
    <div class="statsTwoColumns">
      ${renderRanking("Géneros más presentes", dashboard.topLibraryGenres, "No hay géneros registrados todavía.")}
      ${renderRanking("Géneros más vistos", dashboard.topGenres, "No hay géneros vistos todavía.")}
