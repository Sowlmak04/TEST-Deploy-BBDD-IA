...
function renderHomeDashboard() {
  ...
  root.innerHTML = `
    ...
    ${recommendation
      ...
      : renderHomeRecommendationEmpty({ hasPlatforms })}
...
function renderHomeRecommendationEmpty({ hasPlatforms }) {
  const message = hasPlatforms
    ? "Ahora mismo no tienes pendientes disponibles en tus plataformas."
    : "Configura Mis plataformas para que Inicio pueda proponerte algo que puedas ver ahora.";

  return `
    <section class="homeSection homeRecommendationSection">
      <div class="homeSectionHead">
        <span>
          <span class="statsEyebrow">${hasPlatforms ? "Disponible en tus plataformas" : "Qué puedes ver ahora"}</span>
          <h2>Qué ver ahora</h2>
        </span>
      </div>
  ...
  return `
    <section class="homeSection homeRecommendationSection">
      <div class="homeSectionHead homeRecommendationHead">
        <span>
          <span class="statsEyebrow">Disponible en tus plataformas</span>
          <h2>Qué ver ahora</h2>
        </span>
